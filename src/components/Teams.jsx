        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative overflow-hidden rounded-2xl border
           border-white/5 aspect-[4/5] lg:aspect-[5/6]">
            ...
            <div className="absolute bottom-6 left-6 mono text-[10px] 
          ...
          <div>
            ...
            <p className="text-white/50 text-lg leading-relaxed mb-10 max-w-md">
              Marketing edits copy in the dashboard while engineers own the schema,
              tokens and webhooks. Everyone works on the same content, nobody blocks anybody.</p>
