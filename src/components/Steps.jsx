  ...
  const steps = [
    {
      number: "01",
      title: "Choose",
      description: "Choose your content structure.",
    },
    {
      number: "02",
      title: "Create",
    ...
    },
    {
      number: "03",
      title: "Connect",
      description: "Connect your content to any application.",
    },
    {
      number: "04",
      title: "Publish",
      description: "Publish your content everywhere.",
    },
  ];
    ...
    <section className="bg-black px-6 py-16 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="translate-y-0 opacity-100 transition-all duration-700 delay-0">
          ...
          text-[clamp(2.25rem,5vw,4.5rem)] leading-[1] tracking-tight">
            From idea to{" "}
        ...
        <div className="relative grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-8">
          ...
          {/* Connecting line */}
          <div className="absolute left-[12%] right-[12%] top-8 z-0 hidden
